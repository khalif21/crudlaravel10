    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">HOTEL MERCURE IBIS SAMARINDA</h1>
                    </div><!-- /.col -->
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">EVENT ORDER</span>
      ...
      <!-- /.row --> --}}
        ...
        <div class="col-md-8">
          ...
          <!-- /.row --> --}}
                ...
                $database = 'clonelaravel10'; // Ganti dengan nama database Anda
                ...
                // Langkah 2: Hitung tanggal hari ini dan besok
$today = date("Y-m-d"); // Mengambil tanggal hari ini dalam format YYYY-MM-DD
$tomorrow = date("Y-m-d", strtotime("+1 day", strtotime($today))); // Menghitung tanggal besok
// Langkah 3: Lakukan query untuk mengambil data event hari ini
$query_today = "SELECT * FROM customers WHERE DATE(date) = '$today'"; // Ganti 'nama_tabel' dengan nama tabel Anda dan 'date' dengan nama kolom tanggal
$result_today = mysqli_query($conn, $query_today);

// Langkah 4: Lakukan query untuk mengambil data event besok
$query_tomorrow = "SELECT * FROM customers WHERE DATE(date) = '$tomorrow'"; // Ganti 'nama_tabel' dengan nama tabel Anda dan 'date' dengan nama kolom tanggal
$result_tomorrow = mysqli_query($conn, $query_tomorrow);
                ...
                <div class="card">
                    <div class="card-header border-transparent">
                        <h3 class="card-title">TODAY EVENT</h3>
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result_today)) {
                                        ...
                                        echo '<td>' . $row['meetingroom'] . '</td>'; // Ganti 'meeting_room' dengan nama kolom yang sesuai
                                        echo '<td>' . $row['customer'] . '</td>'; // Ganti 'customer' dengan nama kolom yang sesuai
                                        echo '<td>' . $row['request'] . '</td>'; // Ganti 'request' dengan nama kolom yang sesuai
                                        echo '<td>' . $row['date'] . '</td>'; // Ganti 'date' dengan nama kolom yang sesuai
                                        echo '<td>' . $row['time'] . '</td>'; // Ganti 'time' dengan nama kolom yang sesuai
                                        echo '</tr>';
                                    }
                                    ?>
</tbody>
...
<div class="card">
  <div class="card-header border-transparent">
      <h3 class="card-title">TOMORROW EVENT</h3>
