...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-4">Tambah Data Room Status</h1>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nama" class="form-control" id="exampleFormControlInput1" placeholder="Name">
              </div>
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Room</label>
                <input type="number" name="room" class="form-control" id="exampleFormControlInput1" placeholder="Room">
              </div>
              <div class="mb-3">
